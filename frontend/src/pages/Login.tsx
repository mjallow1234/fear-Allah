          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full p-3 pr-11 bg-[#1e1f22] border border-[#3f4147] rounded text-white focus:outline-none focus:border-[#5865f2]"
                required
              />
              <button
                type="button"
                onClick={() => setShowPassword((v) => !v)}
                className="absolute inset-y-0 right-0 flex items-center justify-center w-11 text-[#87898e] hover:text-[#b5bac1] transition-colors"
                tabIndex={-1}
